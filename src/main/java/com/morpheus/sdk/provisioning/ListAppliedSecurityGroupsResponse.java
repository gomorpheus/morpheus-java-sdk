...
/**
 * The Response of a {@link ListAppliedSecurityGroupsRequest} providing the de-serialized objects from the API.
 * @author Bob Whiton
 */
public class ListAppliedSecurityGroupsResponse implements ApiResponse{
   ...
   * @return success
   */
  public static ListAppliedSecurityGroupsResponse createFromStream(InputStream stream) {
    Gson gson = new Gson();
    InputStreamReader reader = new InputStreamReader(stream);
    return gson.fromJson(reader,ListAppliedSecurityGroupsResponse.class);
  }
}
