 ...
 * @author William Chu
 */
class ListAclRulesRequestSpec extends Specification {
	...
	void "it should successfully retrieve acl rules for an instance by instance id"() {
		given:
		def request = new ListAclRulesRequest()
