 ...
 * @author William Chu
 */
class DisableAclFirewallRequestSpec extends Specification {
	...
	void "it should successfully disable a firewall for a given instance"() {
		given:
		def request = new DisableAclFirewallRequest()
		request.setInstanceId(Integer.parseInt(TEST_INSTANCE_ID))
		when:
